...
{
    public class InlineEditingDemoController : ControllerBase
    {
        ...
        public ActionResult submitAction(string os_project_id, string title, string customer, string company, string businessUnit,
            ...
            string refAndComments, string status, string statusDoc, string dateArchivage, string dateRepport, string initiatedBy, string comments, string project_number, Boolean prjFolderNeedsUpdate)
        {
            ...
            var update = _ListeOffresProjetsService.updateOSProjectTable("OS", os_project_id, title, customer, company, businessUnit,
              ...
              refAndComments, status, statusDoc, dateArchivage, dateRepport, initiatedBy, comments);
            if (update == "success")
            {
        ...
        public ActionResult submitActionForProject(string os_project_id, string refAndComments, string dateArchivage, string dateRepport, string statusDoc, string comments)
        {

            var update = _ListeOffresProjetsService.updateOSProjectTable("PR", os_project_id, null, null, null, null, null,
             null, null, null, null,
            refAndComments, null, statusDoc, dateArchivage, dateRepport, null, comments);
            if (update == "success")
            {
                return Json("succes", JsonRequestBehavior.AllowGet);
            }
